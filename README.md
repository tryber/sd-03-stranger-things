...
- `git clone https://github.com/tryber/sd-03-stranger-things-backend.git`.
- `git clone https://github.com/tryber/sd-03-stranger-things-frontend.git`.

2. Navegue entre as pastas dos repositórios que você acabou de clonar

- `cd sd-03-stranger-things-backend`
- `cd sd-03-stranger-things-frontend`
...
- [Repositório com o frontend](https://github.com/tryber/sd-03-stranger-things-frontend);

- [Repositório com o backend](https://github.com/tryber/sd-03-stranger-things-backend).
